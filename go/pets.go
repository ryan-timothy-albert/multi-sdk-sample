...
func (s *Pets) ListPets(ctx context.Context, limit *int, opts ...operations.Option) (*operations.ListPetsResponse, error) {
...
func (s *Pets) CreatePets(ctx context.Context, request components.Pet, opts ...operations.Option) (*operations.CreatePetsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Pets) ShowPetByID(ctx context.Context, petID string, opts ...operations.Option) (*operations.ShowPetByIDResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
